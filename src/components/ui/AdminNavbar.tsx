...
const NavItems: NavItemType[] = [
    ...
    {
        icon: <Tag size={20} />,
        activeIcon: <Tag size={20} strokeWidth={2.5} />,
        name: "Categories",
        link: "/admin/categories",
    },
    {
        icon: <Package size={20} />,
        activeIcon: <Package size={20} strokeWidth={2.5} />,
        name: "Products",
        link: "/admin/products",
    },
    {
    ...
    },
    {
        ...
        activeIcon: <BarChart3 size={20} strokeWidth={2.5} />,
        name: "Reports",
        link: "/admin/reports",
    },
];
...
export default function AdminNavbar() {
    ...
    return (
        <>
            ...
            <nav className="flex md:hidden justify-between fixed bottom-0 right-0 left-0 bg-white/90 backdrop-blur-lg py-3 px-4 border-t border-t-border z-50">
                {NavItems.map((item, i) => {
