...
export default function KitchenNavbar() {
    ...
    return (
        <>
            ...
            <nav className="flex md:hidden justify-around items-center fixed bottom-0 right-0 left-0 bg-white/90 backdrop-blur-lg py-3 px-4 border-t border-t-border z-50">
                {NavItems.map((item, i) => {
                    ...
                    return (
                        <Link
                            key={i}
                            to={item.link}
                            className={`flex flex-col items-center gap-1 px-4 py-1 transition-colors ${active
                                    ? "text-orange-600"
                ...
                <button
                    ...
                    className="flex flex-col items-center gap-1 px-4 py-1 text-foreground/50 hover:text-red-600 transition-colors"
                >
                    <LogOut size={20} />
